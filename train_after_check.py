...
clf = lgbm.LGBMClassifier(random_state=1, num_leaves = 6, n_estimators=666,max_depth=3,learning_rate = 0.08, n_jobs=30) #0.08199
...
start_features =  ['item_category_list', 'item_city_id', 'item_price_level', 'item_sales_level', 'item_collected_level', 'user_gender_id', 'user_age_level', 'user_star_level', 'context_page_id', 'shop_review_num_level', 'shop_review_positive_rate', 'shop_star_level', 'shop_score_service', 'shop_score_description', 'hour', 'day', 'user_id_query_day', 'user_id_query_day_item', 'user_id_query_day_hour', 'check_ratio', 'check_ratio_day_all', 'check_time_day', 'shop_id', 'shop_id_query_day', 'item_brand_id_query_day_hour', 'shop_id_query_day_hour', 'predict_category_property_L_1', 'predict_category_property_H_3', 'user_occupation_id_query_day_hour', 'user_id_query_day_hour_item'] # 0.08240



clf = lgbm.LGBMClassifier(random_state=1, num_leaves = 6, n_estimators=654,max_depth=3,learning_rate = 0.095, n_jobs=30)
...
clf = lgbm.LGBMClassifier(random_state=1, num_leaves = 6, n_estimators=759,max_depth=3,learning_rate = 0.1, n_jobs=30)

#clf =  xgb.XGBClassifier(seed = 1, max_depth=3, n_estimators=1000)
clf = run(start_features, label, df, clf)
Myprediction(df, start_features, clf, 'Peter_0329', item_category_list_unique)
