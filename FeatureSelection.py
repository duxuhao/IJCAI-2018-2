...
#                  'user_id_query_day_hour_map_item_pv_level'
    ...
    temp = ['item_category_list', 'item_price_level', 'item_sales_level', 'item_collected_level', 'user_gender_id', 'user_age_level', 'user_occupation_id', 'user_star_level', 'context_page_id', 'shop_review_num_level', 'shop_review_positive_rate', 'shop_score_service', 'hour', 'day', 'user_id_query_day_hour', 'shop_id']
    temp = ['item_category_list', 'item_price_level', 'item_sales_level', 'item_collected_level', 'user_age_level', 'user_star_level', 'context_page_id', 'shop_score_service', 'hour', 'day', 'user_id_query_day_hour', 'shop_id', 'check_item_brand_id_ratio', 'check_min_difference_ahead', 'item_city_id_shop_cnt', 'user_id_query_day_hour_item_id']
    temp = ['item_category_list', 'item_price_level', 'item_sales_level', 'item_collected_level', 'user_age_level', 'user_star_level', 'context_page_id', 'shop_score_service', 'hour', 'day', 'user_id_query_day_hour', 'shop_id', 'check_item_brand_id_ratio', 'check_min_difference_ahead', 'item_city_id_shop_cnt', 'user_id_query_day_hour_item_id', 'item_pv_level_user_cnt']
    temp = ['item_category_list', 'item_price_level', 'item_sales_level', 'item_collected_level', 'user_age_level', 'user_star_level', 'context_page_id', 'shop_score_service', 'hour', 'day', 'user_id_query_day_hour', 'shop_id', 'check_item_brand_id_ratio', 'check_min_difference_ahead', 'item_city_id_shop_cnt', 'user_id_query_day_hour_item_id', 'item_pv_level_user_cnt', 'check_ratio_day_all', 'user_id_query_day']
